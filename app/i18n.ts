...
export const translations = {
  fr: {
    ...
    websites: { badge: "Sites Web", title: "Nos réalisations web", sub: "E-commerce, SaaS et vitrines — du brief au déploiement.", visit: "Visiter →" },
    how: {
      badge: "Processus",
    ...
    services: {
      ...
      video: { icon: "🎬", title: "Vidéos IA", desc: "Génération vidéo, clonage vocal, automatisation." },
      web: { icon: "🌐", title: "Sites Web & SaaS", desc: "E-commerce, vitrine, applications sur mesure." },
      voice: { icon: "🎙️", title: "Agent vocal IA", desc: "Voix réaliste, traduction, intégration." },
    },
    voicePricing: {
    ...
    footer: {
      copyright: "© 2026 NovaMedia Studio · Tous droits réservés",
      tagline: "Agence créative · IA & production",
      quickTitle: "Liens rapides",
      home: "Accueil",
      contactTitle: "Contact",
      phone: "+972 58 514 8500",
      email: "contact@dreamnova.ai",
      follow: "Suivez-nous",
    },
  },
  en: {
    ...
    demo: { badge: "Portfolio", title: "Our recent productions" },
    demoDisclaimer: "Real productions from our AI studio.",
    websites: { badge: "Websites", title: "Our web realizations", sub: "E-commerce, SaaS and showcase sites — from brief to launch.", visit: "Visit →" },
    how: {
      badge: "Process",
    ...
    services: {
      ...
      video: { icon: "🎬", title: "AI-Powered Videos", desc: "Video generation, cloning, automation." },
      web: { icon: "🌐", title: "Websites & SaaS", desc: "E-commerce, showcase sites, custom apps." },
      voice: { icon: "🎙️", title: "Voice AI Agent", desc: "Realistic voice, translation, integration." },
    },
    voicePricing: {
    ...
    footer: {
      copyright: "© 2026 NovaMedia Studio · All rights reserved",
      tagline: "Creative agency · AI & production",
  ...
  he: {
    ...
    services: {
      ...
      video: { icon: "🎬", title: "סרטוני AI", desc: "הפקת וידאו, שיבוט קול, אוטומציה." },
      web: { icon: "🌐", title: "אתרים ו-SaaS", desc: "מסחר אלקטרוני, אתר תדמית, אפליקציות מותאמות." },
      voice: { icon: "🎙️", title: "סוכן קולי AI", desc: "קול ריאליסטי, תרגום, אינטגרציה." },
    },
    voicePricing: {
    ...
    footer: {
      copyright: "© 2026 NovaMedia Studio · כל הזכויות שמורות",
      tagline: "סוכנות יצירתית · AI והפקה",
